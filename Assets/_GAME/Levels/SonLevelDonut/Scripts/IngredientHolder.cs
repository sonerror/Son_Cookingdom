...
namespace sonnv
{
  ...
  public class IngredientHolder : SonMonoBehaviour
  {
    ...
    private Dictionary<Collider2D, IngredientForwarder> cachedForwarderDict = new Dictionary<Collider2D, IngredientForwarder>();
