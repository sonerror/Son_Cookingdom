...
namespace AnhPD.CookV2
{
    ...
    {
        [FoldoutGroup("References")][SerializeField] private List<GarbageDrag> garbage;
        [FoldoutGroup("References")]public Transform center;
        
        [FoldoutGroup("Parameters")][SerializeField] private float offsetY = 3f;
