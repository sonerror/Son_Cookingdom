...
namespace AnhPD.CookV2
{
    ...
    {
        [FoldoutGroup("Clock")][SerializeField] private Image cookTimerImage, burntTimerImage;
        [FoldoutGroup("Clock")][SerializeField] private Transform clockwise;
        [FoldoutGroup("Clock")][SerializeField] private AudioSource sfxClock;
        [FoldoutGroup("Vfx")][SerializeField] private GameObject fire;
        [FoldoutGroup("Vfx")][SerializeField] private GameObject vfxDone, vfxBurnt;
        [FoldoutGroup("Vfx")][SerializeField] private ParticleSystem vfxSmoke;
